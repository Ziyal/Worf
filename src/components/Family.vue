<template>
  <div class="family">
    ...
    <img src="../assets/family/worf_alexander.jpg" class="img-alexander">
    ...
    <img src="../assets/family/parents.jpg" class="img-parents">
